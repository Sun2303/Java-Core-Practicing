...
public class CoffeeShopManagementTest {
    ...
    public void shouldAddNewEmployeeSuccessfully(){
        Employees employee01 = new Employees("Sun Beo", "Supervisor", 02, 30);
        Employees employee02 = new Employees("Tran Tuan", "Waiter", 01, 20);
        Employees employee03 = new Employees("Nguyen Minh", "Waiter", 01, 20);
        Employees employee04 = new Employees("Le Hieu", "Cashier", 03, 30);
        Employees employee05 = new Employees("Le Hoang", "Warehouse Manager", 03, 40);
        List<Employees> employeeList = Arrays.asList(employee01,employee02,employee03,employee04,employee05);
    ...
    public void shouldSeeDifferentSalaryForEachLevel(){
        Employees employee01 = new Employees("Sun Beo", "Supervisor", 1995, 35);
        Employees employee02 = new Employees("Tran Tuan", "Waiter", 2000, 20);
        Employees employee03 = new Employees("Nguyen Minh", "Waiter", 1998, 22);
        Employees employee04 = new Employees("Le Hieu", "Cashier", 1995, 35);
        Employees employee05 = new Employees("Le Hoang", "Warehouse Manager", 1992, 35);
        List<Employees> employeeList = Arrays.asList(employee01,employee02,employee03,employee04,employee05);
        Assert.assertEquals(5,employeeList.stream().count());
